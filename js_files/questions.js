	...
	let one = {
		...
		answers: ["True", "False"],
		correctAnswer: "False",
		info: "There are more than 20%; 46% of immigrants reported their race as single-race White, 27% as Asian, 10% as Black, and 15% as some other race. About 2% reported having two or more races",
	};
	let two = {
		question: "DACA provides a pathway to citizenship.",
		answers: ["True", "False"],
		correctAnswer: "False",
		info: 'DACA does not provide a path to citizenship for recipients. It’s very difficult for DACA recipients to become citizens since most are not eligible for a green card. In order to become a citizen, one must first have a green card for 5 years. The primary way to get a green card is through "Family Reunification," which means an immediate relative or spouse who is a citizen must sponsor you and most people with DACA do not have that.',
  };
	let three = {
		question: "The wall is being built on the US-Mexico border",
		answers: ["True", "False"],
		correctAnswer: "True",
		info: "Part of the wall is being built over O'odham land in Arizona and desecrating sacred sites.",
  };
	let four ={
	...
	let five = {
		...
		answers: ["True", "False"],
		correctAnswer: "False",
		info: "Nope nope my bro: let's not base human life on their economic worth. This would be implying that people are only worth as much as the capital they can generate.",
  };
	let six = {
	...
	let eight = {
		...
		answers: ["True", "False"],
		correctAnswer: "False",
		info: "The Department of Homeland Security was signed into law by President George W. Bush on November 25, 2002. ICE was established in March of 2003. Although the United States has a history of xenophobia, we need to stop normalizing the establishment of these new institutions, along with the long-standing ones."
  };
	let nine = {
